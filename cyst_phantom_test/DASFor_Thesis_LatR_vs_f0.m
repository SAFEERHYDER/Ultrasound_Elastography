...
field_init;
%%%%%%%%%%%%% for the system in the lab %%%%%%%%%%%%%%%
% % % for f0=20e6:0.5e6:30e6 % Transducer center frequency [Hz]
...
%%%%%%%%%%%%%% Hilbert Transform %%%%%%%%%%%%%%
    ...
    %     ww=size(ff,1);
    %     env=abs(hilbert(ff/max(max(ff))));
    %     yy(1:length(env),:)=yy(1:length(env),:)+env;
    end
    %%
